...
- The DOS client is a 16-bit real-mode C89 program; it displays 80x25 VGA text, retains 16,384 rows in XMS-backed history, and renders a Markdown subset via VGA attributes.
